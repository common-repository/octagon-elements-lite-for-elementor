...
if( ! class_exists( 'Octagon_Core_Enqueue_Fonts' ) ) {
	...
	class Octagon_Core_Enqueue_Fonts {
		...
		public function enqueue_scripts() {
			...
			wp_enqueue_style( 'octagon-fonts', $this->fonts_enqueue_url(), [], OCTAGON_CORE_VERSION, 'all' );

		}

		/**
		 * Returns Google fonts enqueue url
		 * 
		 * @version  1.0 
		 * @since 1.0
		 * @access public
		...
		public function fonts_enqueue_url() {
			...
			// Advance Typography
			$fonts_collection = apply_filters( 'octagon_enqueue_fonts_list', [] );
