...
class OEE_Content_Type_Slider_Module extends OEE_Widget_Base {
	...
	public function get_name() {
		return 'oee_content_type_slider';
	}
	...
	public function get_title() {
		return esc_html__( 'Content Type Slider', 'octagon-elements-lite-for-elementor' );
	}
	...
	public function get_style_depends() {
		return [ 'oee-content-type', 'oee-content-type-slider', 'oee-advance-button' ];
	}
	...
	protected function set_render_attributes() {
		 ...
		 * 
		 */
		$attributes = apply_filters( 'oee_content_type_slider_render_attribute', [] );
		 ...
		 * 
		 */
		do_action( 'oee_content_type_slider_render_attributes' );
	...
	protected function render() {
		...
		echo oee_get_shortcode_template( 'content-type-slider', $this );
	...
	public function get_slider_data() {
		...
		$slider_data[] = 'data-short-swipes="false"';
