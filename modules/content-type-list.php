...
class OEE_Content_Type_List_Module extends OEE_Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Content Type List', 'octagon-elements-lite-for-elementor' );
	}
	...
	public function get_style_depends() {
		return [ 'oee-content-type-list', 'oee-advance-button' ];
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => 'simple',
				'options' => [
					'simple' => esc_html__( 'Simple', 'octagon-elements-lite-for-elementor' )
				],
			]
		);
	...
	protected function set_render_attributes() {
		 ...
		 * 
		 */
		$attributes = apply_filters( 'oee_content_type_list_render_attribute', [] );
		 ...
		 * 
		 */
		do_action( 'oee_content_type_list_render_attributes' );
	...
	protected function render() {
		...
		echo oee_get_shortcode_template( 'content-type-list', $this );
